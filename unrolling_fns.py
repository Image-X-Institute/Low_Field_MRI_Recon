...
#this line loads the selected unrolling network (implementation needs to be fixed)
#from trained_models.Unrolling.DisCorNet import *  
#from trained_models.Unrolling.DisCorNet_noDC_ctrd import *  

#from trained_models.Unrolling.DisCorNet_orig import * 
from trained_models.Unrolling.DisCorNet_DC import * 

#from trained_models.Unrolling.DisCorNet_DC import *
#from trained_models.Unrolling.DisCorNet_centred import *
import time 
...
#         Unrolling_chi = DisCorNet(7, (75, 25), ini_flag = False)
...
#         R_cal_OP = R_cal((75, 25), Ahb, mask, 'cpu')
#         #R_cal_OP = nn.DataParallel(R_cal_OP)
